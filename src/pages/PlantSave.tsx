...
import { View, Alert, Text, Image, ScrollView, Platform, TouchableOpacity, StyleSheet } from 'react-native';
...
export function PlantSave() {
   ...
   const [showDatePicket, setShowDatePicker] = useState(Platform.OS === 'ios' ? true : false);
      ...
      >
         <View style={styles.container}>
            ...
            <View style={styles.controller}>
               ...
               {Platform.OS === 'android' && (
                  <TouchableOpacity style={styles.dateTimePickerButton} onPress={handleOpenDateTimePicker}>
                     <Text style={styles.dateTimePickerText}>{`Mudar ${format(selectedDateTime, 'HH:mm')} `}</Text>
                  </TouchableOpacity>
               )}

               <Button title='Cadastra planta' onPress={handleSave} />
            </View>
         </View>
      </ScrollView>
   );
